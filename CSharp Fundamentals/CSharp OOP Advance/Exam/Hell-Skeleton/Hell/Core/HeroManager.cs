...
public class HeroManager : IManager
{
    ...
    public string AddRecipe(IList<string> arguments)
    {
        ...
        int hitPointsBonus = int.Parse(arguments[5]);
        int damageBonus = int.Parse(arguments[6]);
        IList<string> requiredItem = arguments.Skip(7).ToList();

        RecipeItem newRecipe = new RecipeItem(itemName, strengthBonus, agilityBonus, intelligenceBonus, hitPointsBonus,
            damageBonus, requiredItem);
